	...
	<div class="row" style="margin-top: 0px; position: relative; padding-bottom: 102px;">
		...
		<div class="mobile-tree visible-xs visible-sm">
			<div class="owl-carousel owl-theme single-slide">
				...
				<div class="item center"><img src="<?=asset('digi-tree/images/mobile-3.png')?>" class="img-responsive" alt="Development"></div>
				<div class="item center"><img src="<?=asset('digi-tree/images/mobile-4.png')?>" class="img-responsive" alt="Paid Search"></div>
				<div class="item center"><img src="<?=asset('digi-tree/images/mobile-5.png')?>" class="img-responsive" alt="Social Media"></div>
				<div class="item center"><img src="<?=asset('digi-tree/images/mobile-6.png')?>" class="img-responsive" alt="Mobile Network Representation"></div>
				<div class="item center"><img src="<?=asset('digi-tree/images/mobile-7.png')?>" class="img-responsive" alt="Mobile Marketing"></div>
